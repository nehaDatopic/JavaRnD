...
public class kafkaTest {
	  ...
	  static final String OUTPUT_PATH = "/home/neha/eclipse_ws/output";  // Default output path
	  static final String BOOTSTRAP_SERVERS = "localhost:2181";  // Default bootstrap kafka servers
